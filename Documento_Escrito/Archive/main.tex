...
\emph{Supervisor:} \\
\href{http://sd.ist.utl.pt/nonlinear_dynamics_group/GDNL_files/RDilao-cv.pdf}{\supname} % Supervisor name - remove the \href bracket to remove the link  
\end{flushright}
\end{minipage}\\[3cm]
