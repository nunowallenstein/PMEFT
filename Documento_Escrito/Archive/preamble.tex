...
\thesistitle[Short Title]{Thesis Title} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
\supervisor{Dr. Jo\v{z}ef \textsc{\v{S}tefan}} % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
...
\author{Ludwig \textsc{Boltzmann}} % Your name, this is used in the title page and abstract, print it elsewhere with \authorname
